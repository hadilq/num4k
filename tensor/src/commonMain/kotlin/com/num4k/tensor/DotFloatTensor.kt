...
class DotFloatTensor(
    private val i: Int,
    private val j: Int,
    private val first: FloatTensor,
    private val second: FloatTensor
) : FloatTensor(
    run {
    ...
    override fun get(vararg position: Int): Float {
        ...
        if (super.get(*position) == default()) {
            ...
            super.set((0 until sumMax).foldIndexed(0f) { index, acc, _ ->
