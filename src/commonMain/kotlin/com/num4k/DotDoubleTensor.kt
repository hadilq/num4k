...
class DotDoubleTensor(
    private val i: Int,
    private val j: Int,
    private val first: DoubleTensor,
    private val second: DoubleTensor
) : DoubleTensor(
    run {
    ...
    override fun get(vararg position: Int): Double {
        ...
        if (super.get(*position) == default()) {
            ...
            super.set((0 until sumMax).foldIndexed(0.0) { index, acc, _ ->
